...
router.get(
    ...
    imageProductController.getImagesByProductId
);
...
router.get(
    "/subcategories/:subcategoryName/:orderby/products",
    productController.getProductsBySubcategory
);
router.get(
    "/categories/:categoryName/:orderby/products",
...
router.get(
    "/productsizecolors/:product_id",
    productSizeColorController.getProductSizeColorById
);
...
router.get(
    "/subcategories",
    subcategoryController.getAllCategoriesWithSubcategories
);
router.get(
