...
function ManageProduct() {
    ...
    useEffect(() => {
        axios
            ...
            .catch(() => {});
        axios
            .get(`${API_URL}/api/subcategories/0`)
            .then((response) => {
            ...
            .catch(() => {});
        axios
            .get(`${API_URL}/api/colors`)
            .then((response) => setColors(response.data))
            .catch(() => {});
        axios
            .get(`${API_URL}/api/sizes`)
            ...
            .then((response) => {
                if (response.status === 200) {
                    ...
                    setTimeout(() => {
                        ...
                        axios
                            .get(`${API_URL}/api/subcategories/${category_id}`)
                        ...
                        axios
                            .get(`${API_URL}/api/productsizecolors/${_id}`)
                            .then((response) => {
                                if (response.status === 200) {
    ...
    const clickBtnAdd_Edit = () => {
        ...
        if (idItem === 0) {
            ...
            axios
                .put(`${API_URL}/api/products/${idItem}`, formData, {
                    headers: {
                        "Content-Type": "multipart/form-data",
                    },
                })
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    onChange={(
                                                                        ...
                                                                        axios
                                                                            .get(
                                                                                `${API_URL}/api/subcategories/${e.target.value}`
                                                                            )
                                                                            .then(
                                                                                (
                                                                                    response
