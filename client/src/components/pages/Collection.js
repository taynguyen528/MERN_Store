...
function Collection() {
    ...
    useEffect(() => {
        if (!category) {
            axios
                .get(`${API_URL}/api/categories/${name}/manual/products`)
                .then((response) => {
            ...
            axios
                .get(`${API_URL}/api/subcategories/${name}/manual/products`)
                .then((response) => {
                    setDataByCategory(response.data);
                })
                .catch(() => {});
                        ...
                        <div className="container">
                            <div className="row">
                                {dataByCategory.length > 0 ? (
                                    <div
                                        id="collection-body"
                                        className="wrap-collection-body clearfix"
                                    >
                                                ...
                                                <div className="heading-collection row">
                                                    ...
                                                    <div className="col-md-4 hidden-sm hidden-xs">
                                                        <div className="option browse-tags">
                                                            <label className="lb-filter hide">
                                                                Sắp xếp theo:
                                                            </label>
                                                                ...
                                                                <select
                                                                    ...
                                                                    onChange={(
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            axios
                                                                                .get(
                                                                                    `${API_URL}/api/categories/${name}/${e.target.value}/products`
                                                                                )
                                                                                .then(
                                                                                    (
                                                                                        response
                                                                            ...
                                                                            axios
                                                                                .get(
                                                                                    `${API_URL}/api/subcategories/${name}/${e.target.value}/products`
                                                                                )
                                                                                .then(
                                                                                    (
                                                                                        response
